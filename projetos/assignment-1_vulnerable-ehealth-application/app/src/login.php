    ...
    <div class="container-fluid pl-0 pr-0 h-100">
        <div class="row h-100">
            ...
            <div class="col-4 h-100 d-flex justify-content-center align-items-center">
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" class="rounded shadow" style="background-color: rgba(249,251,250,255); min-height: 200px; min-width: 250px; width:380px;height:380px">
