<?php
    ...
    $first_name = $query_users["first_name"];
    $last_name = $query_users["last_name"];
    $email = $query_users["email"];
    $image = $query_users['image'];
    $roles = new roles();
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <?php if(strcmp($category , "Doctor") == 0)
                  {
                    ...
                    $speciality_id = $speciality_query["specialties_id"];
                    $speciality_name = $speciality->select_by_id($speciality_id)->fetch_assoc()["name"];
            ...
            if(strcmp($category , "Patient") == 0 or strcmp($category , "Administrator") == 0)
            {
              ...
              while($row = $query_appointments->fetch_assoc())
              {
                if($row["completed"] == 0)
                {
                  ...
                  $doctor_name = $doctor_query["first_name"]." ".$doctor_query["last_name"];
                  ...
                  <form action='/open_pdf.php' method='get'>
            ...
            else if(strcmp($category , "Doctor") == 0)
            {
              ...
              while($row = $query_appointments->fetch_assoc())
              {
                if($row["completed"] == 0)
                {
                  ...
                  $patient_name = $patient_query["first_name"]." ".$patient_query["last_name"];
                  ...
                  echo '<button type="button" onclick="finish_appointment('.$row["id"].')" class="btn btn-success" style="display:inline-flex" type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
                      <div style="float:left">
                        Done &nbsp;
                      </div>
                <div style="float:right">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="md-form">
          <form action="/confirm_appointment.php" id="doneform" method="post">
