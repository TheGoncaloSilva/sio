                ...
                <div class="col-md-6">
                  <div class="detail-box">
                    <div>
                      ...
                      <p>
                        We offer a wide variety of specialties under our services category. Our doctors are some of the most highly regarded in their fields
                      </p>
                      <a href="./service.php">
                        See More
                      </a>
                ...
                <div class="col-md-6">
                  <div class="detail-box">
                    <div>
                      ...
                      <p>
                        If you have any doubts about our services, pricing or would like to ask us anything, kindly ask us in contact page
                      </p>
                      <a href="./contact.php">
                        Contact Us
                      </a>
  ...
  <section class="service_section layout_padding-bottom">
    <div class="container">
      <div class="heading_container heading_center">
        ...
        <p>
          This are some of our services. Press view all to see our full offer
        </p>
      </div>
      <div class="row">
        <div class="col-md-1">
        ...
        <?php
          ...
          {
            echo '
            <form method="GET" action="./appointment.php"><div class="row">';
            ...
            while($row = $all->fetch_assoc())
            {
              echo '<div class="col-md-4 mx-auto">
                      <div class="box">
                      <button class="btn" name="spec" type="submit" value="'.$row["id"].'">
