<?php
    ...
    if(!isset($_SESSION['userEmail']) or !isset($_GET['permission']) or $_GET['permission'] != 1) {
...
<?php
			...
			<table class="table">
				...
				<tbody>
					...
					if ($result->num_rows > 0) {
						...
						echo "<td>\n";
						echo "<button type='button' class='btn btn-info' onclick='admin_manage(".'"'.$row['first_name'].'","'.$row['last_name'].'","'.$row['id'].'",'.$is_doctor.")'".' data-toggle="modal" data-target="#exampleModal">'."\n";
				...
				<tbody>
					...
					<?php
						...
						while($row = $contacts_query->fetch_assoc())
						{
							...
							<td>".$timestamp."</td>
							<td>
							<form action='".$_SERVER['PHP_SELF']."' id='removeReport' method='POST'>
	...
	<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		...
		<div class="modal-content">
			...
			<form action="change_permission.php" id="form_changes" method="post">
